...
function WatchHistory() {
  ...
  return (
   ...
   <div className="container mt-5 mb-3 d-flex justify-content-between">
    <h2>Watch-History</h2>
     <Link style={{textDecoration:"none",color:"blueviolet",fontSize:"30px"}} to={"/home"}>Back to Home <i class="fa-solid fa-rotate-left fa-beat-fade"></i></Link>
   </div>
    ...
    <tbody>

      {
        history?.length>0?history.map((video,index)=>(
          ...
          <td><button onClick={()=>removeVideoHistory(video?.id)} className='btn'><i class="fa-solid fa-trash text-danger"></i></button></td>
        </tr>
